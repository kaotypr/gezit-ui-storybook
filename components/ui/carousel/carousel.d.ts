...
declare function CarouselPrevious({ className, variant, size, color, ...props }: React.ComponentProps<typeof Button>): import("react/jsx-runtime").JSX.Element;
declare function CarouselNext({ className, variant, size, color, ...props }: React.ComponentProps<typeof Button>): import("react/jsx-runtime").JSX.Element;
